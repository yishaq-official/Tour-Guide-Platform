  ...
  if (!heritage) {
    return (
      <div className="text-center py-32 bg-gray-50 min-h-screen">
        ...
        <Link to="/heritages" className="text-green-600 mt-6 inline-block hover:underline text-lg">Return to Gallery</Link>
      </div>
    );
  }
      ...
      <div className="relative h-[60vh] md:h-[75vh] w-full">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-8 md:p-16">
          <div className="max-w-7xl mx-auto">
            <Link to="/heritages" className="inline-flex items-center text-white/80 hover:text-white mb-8 transition-colors text-sm font-semibold uppercase tracking-wider bg-white/10 px-4 py-2 rounded-full backdrop-blur-sm border border-white/20">
