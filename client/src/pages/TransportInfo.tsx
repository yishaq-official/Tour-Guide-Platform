    ...
    <div className="w-full bg-gray-50 min-h-screen pb-20">
      ...
      <div className="bg-gray-900 text-white py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6 tracking-tight">Getting Around Ethiopia</h1>
          <p className="text-lg text-gray-300 max-w-2xl mx-auto">
            From domestic flights spanning the country to comfortable intercity buses, find all the information you need to navigate Ethiopia safely and efficiently.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 -mt-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Domestic Flights</h2>
          ...
          >
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Intercity Buses</h2>
            <p className="text-gray-600 mb-6 leading-relaxed">
          ...
          >
            <div className="w-14 h-14 bg-yellow-50 rounded-xl flex items-center justify-center mb-6">
              <Train className="w-7 h-7 text-yellow-600" />
            </div>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Railway</h2>
            <p className="text-gray-600 mb-6 leading-relaxed">
            ...
            <ul className="space-y-3 text-sm text-gray-700">
              <li className="flex items-center gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-yellow-600 shrink-0" />
          ...
          >
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Local Transport & Ride-Hailing</h2>
            <p className="text-gray-600 mb-6 leading-relaxed">
