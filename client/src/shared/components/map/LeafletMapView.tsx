...
import { initLeafletIcons, createCustomIcon } from "./mapUtils";
import { ResizeHandler, FlyToLocation } from "./MapControls";
...
export function LeafletMapView({ lat, lng, name }: LeafletMapViewProps) {
